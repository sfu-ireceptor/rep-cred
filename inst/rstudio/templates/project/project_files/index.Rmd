...
if (!is_compliant) {
  repcred:::formattedErrorMeassage("The repertoire is not AIRR compliant. Exiting analysis.")
  knitr::knit_exit()
}
...
if (length(missing_columns) > 0) {
    ...
    if ("sequence_alignment" %in% missing_columns) {
        ...
        if (!sequence_alignment_available) {
            repcred:::formattedWarningMeassage("Required `sequence_alignment` is empty.")
        }
    }
